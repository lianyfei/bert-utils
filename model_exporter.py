...
flags.DEFINE_string("data_path", 'tmp/result/', "saved model path")

flags.DEFINE_string("labels_num", '2', "number of your labels")

flags.DEFINE_string("export_path", 'tmp/pb_model/', "savedModel export path")
